...
{
    [Description("Indexes a package store")]
    public class ReindexCommand : Command<ReindexCommand.Settings>
    {
        public class Settings : CommandSettings, IMetadataStoreOptions
        {
            ...
            [CommandOption("--force")]
            [Description("Force indexing even when not required")]
