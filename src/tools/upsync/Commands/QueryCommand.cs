...
{
    [Description("Query package metadata from a package store")]
    public class QueryCommand : Command<QueryCommand.Settings>
    {
        public class Settings : CommandSettings, IMetadataStoreOptions, IMetadataFilterOptions
        {
            ...
            [CommandOption("--include-bundled")]
            [Description("Include bundled updates by other updates")]
            ...
            [CommandOption("--first")]
            [Description("Display first x updates only")]
            public int FirstX { get; set; }

            [CommandOption("--after")]
            [Description("Exclude first x updates(applies before --first)")]
            ...
            [CommandOption("--json-out-path")]
            [Description("Save results as JSON to the specified path")]
            public string JsonOutPath { get; set; }

            [CommandOption("--include-extended-metadata")]
            [Description("Include extended metadata when saving to JSON query result.")]
            ...
            public override ValidationResult Validate()
            {
                ...
                {
                    return ValidationResult.Error("--package-type is required.");
                }
