...
{
    [Description("Serve updates to downstream servers")]
    public class RunUpstreamServerCommand : Command<RunUpstreamServerCommand.Settings>
    {
